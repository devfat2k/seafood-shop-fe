...
export function CheckoutItemsSummary({ items, note, onNoteChange }: CheckoutItemsSummaryProps) {
  return (
          ...
          <div key={item.id} className="flex items-center justify-between gap-4 py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {item.weight && (
                  <p className="text-[11px] text-muted-foreground">Quy cách: {item.weight}</p>
                )}
