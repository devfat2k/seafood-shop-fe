    ...
    <header className="sticky top-0 z-40 w-full border-b border-[#E4E0D8] bg-[#FBF8F3]/90 backdrop-blur-md">
      <div className="mx-auto flex h-20 max-w-[1280px] items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/sign-in"
            className="flex items-center gap-1.5 rounded-full border border-[#E4E0D8] bg-white px-3.5 py-2 text-xs font-semibold text-[#26312D] transition-colors hover:border-[#0E3D34] hover:text-[#0E3D34]"
          >
