  ...
  'group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2.5 py-0.5 text-xs font-semibold whitespace-nowrap transition-all focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!',
  {
    variants: {
      variant: {
        ...
        tertiary: 'bg-tertiary text-tertiary-foreground [a]:hover:bg-tertiary/90',
        accent: 'bg-accent text-accent-foreground [a]:hover:bg-accent/90',
        hot: 'bg-primary/10 text-primary border-primary/20 [a]:hover:bg-primary/20',
        new: 'bg-secondary/10 text-secondary border-secondary/20 [a]:hover:bg-secondary/20',
        sale: 'bg-accent/15 text-accent-text border-accent/30 [a]:hover:bg-accent/25',
        inStock: 'bg-tertiary/10 text-tertiary-text border-tertiary/20 [a]:hover:bg-tertiary/20',
        outOfStock:
          'bg-destructive/10 text-destructive-text border-destructive/20 [a]:hover:bg-destructive/20',
        destructive:
