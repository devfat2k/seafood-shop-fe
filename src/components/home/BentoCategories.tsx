    ...
    <section className="bg-[#FBF8F3] py-16 lg:py-24">
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-3">
          {/* Card Lớn bên trái (Combo BBQ - chiếm 2 cột desktop) */}
          {mainCombo && (
            <div className="group relative overflow-hidden rounded-3xl border border-[#E4E0D8] bg-[#0E3D34] text-white shadow-lg lg:col-span-2">
              ...
              <img
                src={mainCombo.image}
                alt={mainCombo.title}
                className="h-full min-h-[380px] w-full object-cover opacity-60 transition-transform duration-500 group-hover:scale-105"
              />
          ...
          <div className="flex flex-col gap-6 lg:col-span-1">
            ...
            {lobsterCard && (
              <div className="group relative overflow-hidden rounded-3xl border border-[#E4E0D8] bg-[#0E3D34] text-white shadow-md">
                ...
                />
                <div className="absolute inset-0 flex flex-col justify-between bg-gradient-to-r from-black/70 to-transparent p-6">
                  <div>
